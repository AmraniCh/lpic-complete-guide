...
weight: 1
status: written
description: "Manage shared libraries. Candidates should be able to determine the shared libraries that executable programs depend on and install them when necessary."
---
