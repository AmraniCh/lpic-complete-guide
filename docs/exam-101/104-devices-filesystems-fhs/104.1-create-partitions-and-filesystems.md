...
weight: 2
status: written
description: "Create partitions and filesystems. Candidates should be able to configure disk partitions and then create filesystems on media such as hard disks."
---
